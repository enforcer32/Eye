...
namespace Eye
{
	namespace AST
	{
		...
		*/
		...
		{
		public:
			FunctionStatement(const Utility::EyeSource& source, const std::shared_ptr<Lexer::Token>& returnType, const std::shared_ptr<IdentifierExpression>& identifier, const std::vector<std::shared_ptr<FunctionParameter>>& parameters, const std::shared_ptr<BlockStatement>& body)
