...
namespace Eye
{
	namespace Error
	{
		...
		{
			UnexpectedTokenException::UnexpectedTokenException(const std::string& token, const Utility::EyeSource& source)
				: std::exception()
			{
			...
			std::string UnexpectedTokenException::GetErrorLine(const Utility::EyeSource& source)
			{
